...
function Contact() {
  function envoyerMail() {
    ...
    var lien =
      "mailto:olanier.mickael@yahoo.fr?subject=Demande d'information&body=" +
      encodeURIComponent(message + message2);
  ...
  return (
    <div className="con-all">
      ...
      <div className="con-txt">Contact moi via mail ou Instagram.</div>
      <div className="con-box">
        <div className="con-box3">
          <div className="con-box2">
            <div className="con-txt2">MON EMAIL</div>
            <input
              id="con-email2"
              value="olanier.mickael@yahoo.fr"
              type="text"
              readonly
            />
            <div className="con-txt2">MESSAGE</div>
