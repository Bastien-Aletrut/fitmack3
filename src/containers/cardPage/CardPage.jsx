...
function CardPage(id) {
  ...
  [(<>Tu me contactes via mails ou insta, suite à cela je tenvoie une fiche me permettant de faire ton bilan morphologique ainsi que le reste puis on planifie un premier entretien téléphonique ou physique si possibilité (gratuit et sans engagement) pour discuter de tes objectifs plus en détail pour finir avec un test d'aptitude physique. <br /><br /> ​Si tu es partant(e) pour commencer un programme d'entraînement online ou du training à domicile, je te prépare ton programme sur mesure pour atteindre ces fameux objectifs ! <br /><br /> Pour le coaching online, tu t'entraînes où tu veux, juste à suivre le plan d'entraînement et de nutrition !","Améliorer son physique et ses performances. Augmenter sa masse musculaire. Adapté à tout les niveaux. Optimiser l’alimentation à travers un suivi et des conseils nutritionnels Programmation basée selon vos qualités et vos faiblesses Structuration et optimisation des séances au travers de cycles réguliers."</>),
   ...
   "Réduire sa masse grasse à travers le sport par des exercices de renforcement musculaire et cardio-vasculaire. Personnalisé selon vos éventuelles pathologies (diabète, articulaires, cardio-vasculaire etc.) Suivi et conseils nutritionnels (définition du métabolisme basal, des apports et dépenses journalières etc.) Programmation personnalisé, mise en place de cycles de travail et d’objectifs réguliers. Maintenir une motivation constante.", 
   "Améliorer sa posture et réduire les douleurs chroniques. nalyse morphologique et pathologique individualisée. Améliorer sa tonicité musculaire, lutter contre les raideurs et le manque de mobilité. Intégrer la programmation à la vie quotidienne pour développer de bonnes habitudes. Rappelle moi de t'envoyer le reste quand tu as finit avec ça car je vais surement oublier"];
