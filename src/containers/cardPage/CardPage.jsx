...
function CardPage(id) {
  ...
  const tabText = [
    <>
      Tu me contactes via mails ou insta, suite à cela je t'envoie une fiche me
      permettant de faire ton bilan morphologique ainsi que le reste puis on
      planifie un premier entretien téléphonique ou physique si possibilité
      (gratuit et sans engagement) pour discuter de tes objectifs plus en détail
      pour finir avec un test d'aptitude physique. <br />
      <br /> ​Si tu es partant(e) pour commencer un programme d'entraînement
      online ou du training à domicile, je te prépare ton programme sur mesure
      pour atteindre ces fameux objectifs ! <br />
      <br /> Pour le coaching online, tu t'entraînes où tu veux, juste à suivre
      le plan d'entraînement et de nutrition !
    </>,
    ...
    "La force athlétique, ou powerlifting, est l'art de maîtriser trois levées principales : le squat, le développé couché et le soulevé de terre. Ce sport exigeant met l'accent sur la force maximale et la technique, offrant des bénéfices exceptionnels pour la force physique, la stabilité et la confiance en soi. Augmentation de la Force ,amélioration de la Condition Physique et renforcez votre posture, votre stabilité et votre coordination. Prenez le contrôle de votre force et découvrez votre potentiel.",
  ];
